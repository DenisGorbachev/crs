...
codex-tui = { git = "https://github.com/openai/codex", tag = "rust-v0.153.4", version = "0.153.4" }
...
[patch.crates-io]
# `codex-tui` requires the buffered-input APIs from the Codex workspace's crossterm fork.
